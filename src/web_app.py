...
from src.model import CreateNote , ReadNoteById , GetNoteTimeInfo , UpdateNoteText , PrintNoteId , DeleteNoteById

api_router = fastapi.APIRouter()
local_path = "G:\\Учеба\\5 семестр\\Информатика в приложении к отрасли\\Лаба 5"

path = local_path+"\\_notes\\"
token_path = local_path+"\\_tokens\\_token1.txt"
